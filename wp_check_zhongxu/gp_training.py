...
class Training_COS_HOD_fsat:
    ...
    def value(self, name='fsat'):
        self.fold = open("/export/sirocco1/zz681/emulator/CMASS/Gaussian_Process//CMASS_training_error/output_fsat/output_cosmo_"+str(self.CID)+"_Box_0_HOD_"+str(self.HID)+".dat", "r")
...
class Training_wp_COS_HOD_error:
    ...
    def __init__(self, CID, HID, rpbin):
        ...
        self.GP_error = np.loadtxt("/export/sirocco1/zz681/emulator/CMASS/Gaussian_Process/wp_covar/wp_covar_data/data/Minerva_error.dat")
...
class Test_COS_HOD_fsat:
    ...
    def value(self, name='fsat'):
        self.fold = open("/Users/zhongxuzhai/Documents/work/research/LSS/emulator/CMASS/CMASS_error_analysis/test_HOD_1000/output_cosmo_"+str(self.testCID)+"_Box_0_HOD_"+str(self.testHID)+".dat", "r")
        for line in self.fold:
            if name in line[:10]:
                newline = line.split()
                if name == 'M_min':
...
class Test_wp_COS_error_COS_HOD:
    ...
    def __init__(self, testCID, testHID):
        ...
        for BID in range(0,5):
            for j in range(0,10):
                d = np.loadtxt("/Users/zhongxuzhai/Documents/work/research/LSS/emulator/CMASS/GP/GP_test_data/Test_Box_wp_covar/wp_covar_cosmo_"+str(self.testCID)+"_Box_"+str(BID)+"_HOD_"+str(self.testHID)+"_test_"+str(j)+".dat")
                self.dd[:,s] = d[:,1]
                s=s+1
...
class Test_RSD_COS_error_COS_HOD:
    ...
    def __init__(self, testCID, testHID):
        ...
        for BID in range(0,5):
            for j in range(0,10):
                d = np.loadtxt("/Users/zhongxuzhai/Documents/work/research/LSS/emulator/CMASS/GP/GP_test_data/Test_Box_RSD_multiple/RSD_multiple_cosmo_"+str(self.testCID)+"_Box_"+str(BID)+"_HOD_"+str(self.testHID)+"_test_"+str(j)+".dat")
